...
public class Todayspecial_list {
    ...
    private String brand_companie_name;
    ...
    public String getBrand_companie_name() {
        return brand_companie_name;
    }

    public void setBrand_companie_name(String brand_companie_name) {
        this.brand_companie_name = brand_companie_name;
    }
    ...
    public int getIn_cart_qty() {
        return in_cart_qty;
    }

    public void setIn_cart_qty(int in_cart_qty) {
        this.in_cart_qty = in_cart_qty;
    }

    @Override
    public String toString() {
        return "ClassPojo [product_dp = " + product_dp + ", other_margin_list = " + other_margin_list + ", image = " + image + ", min_order_qty = " + min_order_qty + ", margin = " + margin + ", free_product_details = " + free_product_details + ", is_favorite = " + is_favorite + ", is_free_product = " + is_free_product + ", thumb_image = " + thumb_image + ", pro_qty_for_free = " + pro_qty_for_free + ", subcategory_name = " + subcategory_name + ", description = " + description + ", brand_name = " + brand_name + ", mrp_price = " + mrp_price + ", brand_companie_name = " + brand_companie_name + ", retail_price = " + retail_price + ", min_qty_for_free = " + min_qty_for_free + ", product_id = " + product_id + ", qty = " + qty + ", name = " + name + ", in_cart_qty = " + in_cart_qty + "]";
    }
}
