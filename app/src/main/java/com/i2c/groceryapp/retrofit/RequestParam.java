...
public class RequestParam {
    ...
    public static final String BRAND_COMPANY_ID = "brand_companie_id";
    public static final String PROFILE_IMAGE = "logo";
    ...
    public static final String ANNIVERSARY_DATE = "aniversary_date";
