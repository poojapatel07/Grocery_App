...
public class RvTodaysSpecialMOQListADP extends RecyclerView.Adapter<RvTodaysSpecialMOQListADP.MyViewHolder> {
    ...
    public RvTodaysSpecialMOQListADP(Activity activity, ArrayList<Other_margin_list> all_product_moq,
