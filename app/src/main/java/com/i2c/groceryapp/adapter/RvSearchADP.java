...
public class RvSearchADP extends RecyclerView.Adapter<RvSearchADP.MyViewHolder> {
    private final Activity activity;
    private ArrayList<Todayspecial_list> freebies_arraylist;
    private AddtoFavouriteFree addtoFavourite;
    ...
    public RvSearchADP(Activity activity, ArrayList<Todayspecial_list> freebies_arraylist,
...
//                            Utility.BADGE_PRICE);
    ...
    @NonNull
    @Override
    public RvSearchADP.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RvSearchADP.MyViewHolder holder, int position) {
        Glide.with(activity)
