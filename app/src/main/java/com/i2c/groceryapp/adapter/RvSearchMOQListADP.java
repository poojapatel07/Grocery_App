...
public class RvSearchMOQListADP extends RecyclerView.Adapter<RvSearchMOQListADP.MyViewHolder> {
    ...
    public RvSearchMOQListADP(Activity activity, ArrayList<Other_margin_list> all_product_moq,
