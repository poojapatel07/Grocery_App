...
public class RvProductCategoryMOQListADP extends RecyclerView.Adapter<RvProductCategoryMOQListADP.MyViewHolder> {
    ...
    public RvProductCategoryMOQListADP(Activity activity, ArrayList<Other_margin_list> all_product_moq,
                                       HashMap<Integer, Boolean> map, CheckedMOQ checkedMOQ) {
