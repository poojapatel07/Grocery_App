...
public class RvTradeOfferMOQListADP extends RecyclerView.Adapter<RvTradeOfferMOQListADP.MyViewHolder> {
    ...
    public RvTradeOfferMOQListADP(Activity activity, ArrayList<Other_margin_list> all_product_moq,
